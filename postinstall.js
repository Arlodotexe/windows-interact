	...
	checkInstall: () => {
		Win.PowerShell('Get-AudioDevice -List', result => {
			if (result.includes('Index')) {
				...
				Win.error('The AudioDevicesCmdlet did not installed correctly. Please try again. If this does not install, you will lose audio device management functionality.');
			}
		}, { noLog: true });
	}
}
